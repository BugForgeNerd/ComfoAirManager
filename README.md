...
Wird eine ComfoAir-Anlage über eine **CC Luxe** oder **CC Ease** (im Folgenden *Fernbedienung* genannt) betrieben, stehen dort die Betriebsarten **Automatik**, **Stufe 0**, **Stufe 1**, **Stufe 2** und **Stufe 3** zur Verfügung. Die Betriebsart *Automatik* arbeitet dabei ein in der Fernbedienung hinterlegtes Kalender- bzw. Zeitprogramm ab.
