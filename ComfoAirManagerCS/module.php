 ...
 * - Gateway auf Vorhandensein überprüfen
 * - 
 * - 
 * - 
...
class ComfoAirManagerCS extends IPSModule
{
	 ...
	 * @return void
	 */
    public function SendTestCommand()
    {
	 ...
	 * @return void
	 */
	private function SendCommand(int $command, array $data)
	{
	 ...
	 * @return void
	 */
	private function SendRaw(string $binary)
	{
	 ...
	 * @return void
	 */
	private function ProcessRxBuffer()
	{
	 ...
	 * @return void
	 */
	private function DispatchCommand(int $command, array $data)
	{
...
*/
	 ...
	 * @return void
	 */
	protected function UpdateAutoReadScheduler()
	{
		$config = json_decode($this->ReadAttributeString('ReadGroupsConfig'), true) ?? [];
	 ...
	 * Parameter: keine
	 */
	public function CreateWochenplan()
	{
	 ...
	 */
	public function SetRequestActionInt(string $Ident, int $Value)
	{
		$this->RequestAction($Ident, $Value);
	}
	public function SetRequestActionBool(string $Ident, bool $Value)
	{
		$this->RequestAction($Ident, $Value);
	}			
	public function SetRequestActionString(string $Ident, string $Value)
	{
		$this->RequestAction($Ident, $Value);
	}
	public function SetRequestActionFloat(string $Ident, float $Value)
	{
		$this->RequestAction($Ident, $Value);
	}
	 ...
	 *   Keine Parameter.
	 */	
	public function CheckHeatControl()
	{
		$this->CheckHeatControlInternal();
	}

	protected function CheckHeatControlInternal()
	{
	 ...
	 *   Keine Parameter.
	 */
	protected function ApplyHeatStop()
	{
	 ...
	 *   Keine Parameter.
	 */
	protected function ReleaseHeatStop()
	{
		if (!$this->GetValue('LueftungAusWegenHitze')) {
			return;
		}
